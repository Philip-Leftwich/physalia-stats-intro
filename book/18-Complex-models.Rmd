...
downloadthis::download_link(
  link = "https://raw.githubusercontent.com/UEABIO/data-sci-v1/main/book/files/fruitfly.csv",
...
```{task}
Think carefully about the plots you should make to investigate the potential differences and relationships you wish to investigate - examples hidden behing this dropdown
```
...
**Q** Does it like size affects longevity? `r mcq(c(answer = "Yes","No"))`
...
In these faceted plots - Are the trendlines moving in the same direction?  `r mcq(c("Yes", answer ="No"))`
